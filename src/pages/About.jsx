      ...
      >
        ...
        <div className="relative max-w-[1420px] mx-auto px-5 lg:px-16 pt-12 lg:pt-20">
          <div className="max-w-[520px]">
           <h2 className="font-bold text-[#06134A] leading-none">
  <span className="block text-[34px] sm:text-[42px] lg:text-[44px]">
    About the
  </span>

  <span className="block mt-2 text-[44px] sm:text-[52px] lg:text-[54px] font-bold tracking-[-2px]">
    IDEAX 2026
  </span>
</h2>
            ...
            <p className="mt-8 w-[350px] text-[15px] lg:text-[15px] leading-6 font-semibold text-[#07113F]/90">
      ...
      <main className="max-w-[1420px] mx-auto px-4 lg:px-16">
        ...
        <section className="relative z-10 grid grid-cols-1 lg:grid-cols-[250px_250px_1fr] gap-4 -mt-4">
          {[
            ...
            >
              <h4 className="font-bold text-[#07113F]">{card.title}</h4>
              <card.icon className="mx-auto my-8 w-14 h-14 text-[#0B63FF]" />
              <p className="text-[14px] leading-7 font-semibold text-[#07113F]/80">{card.desc}</p>
            </div>
          ))}

          <div className="bg-white rounded-2xl p-6 shadow-[0_8px_25px_rgba(0,40,120,0.14)]">
            <h4 className="text-center font-bold text-[#0637C8] mb-7">CORE FOCUS AREAS</h4>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-5">
              {focusAreas.map((f) => (
                <div key={f.title} className="text-center group">
                  ...
                  >
                    <f.icon className="-rotate-45 w-10 h-10" style={{ color: f.color }} />
                  </div>
                  <h5 className="mt-6 font-semibold text-[14px]" style={{ color: f.color }}>
                    {f.title}
                  </h5>
        ...
        <section className="py-12">
          <h3 className="text-center text-[22px] font-bold text-[#0637C8]">CONFERENCE TRACKS</h3>
  ...
  />
        ...
        <section className="grid grid-cols-1 lg:grid-cols-[420px_1fr] gap-6 py-8">
          <div className="bg-white rounded-2xl p-8 shadow-[0_8px_24px_rgba(0,40,120,0.12)]">
            <h3 className="font-bold mb-4">WHY PARTICIPATE?</h3>
    ...
    {[
      ...
      >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-[1fr_480px] gap-8 py-8">
          <div>
            <h3 className="text-center text-[22px] font-bold text-[#0637C8] mb-8">WHO SHOULD ATTEND?</h3>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {["Researchers & Academicians", "Industry Professionals", "Students & Scholars", "Policy Makers & Government", "Startups & Innovators"].map(
                (x, i) => (
                  <div key={x} className="text-center bg-white rounded-2xl p-4 shadow-md hover:-translate-y-2 transition">
                    ...
                    <p className="mt-4 text-[13px] font-bold">{x}</p>
                  </div>
                )
              )}
            </div>
          ...
          <div className="bg-white rounded-2xl p-5 shadow-[0_8px_24px_rgba(0,40,120,0.12)]">
            <h3 className="text-center text-[22px] font-bold text-[#0637C8] mb-6">IMPORTANT DATES</h3>
            <div className="space-y-3">
              {dates.map(([name, date]) => (
                <div key={name} className="flex items-center justify-between gap-4 font-semibold text-[13px]">
        ...
        <section className="py-8">
          <h3 className="text-center text-[22px] font-bold text-[#0637C8] mb-7">PUBLICATION & INDEXING</h3>
            ...
            {[
              ...
              <div key={title} className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[14px] font-medium mt-1">{desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="w-[480px] ml-[50px]">
                <h2 className="text-[18px] lg:text-[24px] font-semibold">Be Part of IDEAX 2026</h2>
            ...
            <button className="bg-[#FFB000] mr-14 text-[13px] text-[#07113F] px-4 py-3 rounded-xl font-bold flex items-center gap-4 hover:scale-105 transition">
