...
export default function SubmitPaperConfirm() {
  return (
    <main className="bg-[#F8FAFF] text-[#07113F] px-4 sm:px-6 lg:px-10 overflow-hidden">
      ...
      <div className="mt-8 mb-8 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 max-w-[900px]">
...
function ReviewItem({ icon: Icon, color, title, lines, last }) {
  return (
    <motion.div
      whileHover={{ x: 4 }}
      className={`flex gap-5 py-6 ${!last ? "border-b border-[#DCE8FA]" : ""}`}
    >
      <span
...
function SummaryRow({ label, value }) {
  return (
    <div className="grid grid-cols-[130px_1fr] gap-4 text-[13px] leading-6">
